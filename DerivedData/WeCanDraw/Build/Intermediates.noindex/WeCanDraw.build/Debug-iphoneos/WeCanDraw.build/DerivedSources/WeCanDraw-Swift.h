...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WeCanDraw",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9WeCanDraw11AppDelegate")
...
SWIFT_CLASS("_TtC9WeCanDraw4Draw")
@interface Draw : NibView
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified feedBack;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified clickedBlue;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified clickedPurple;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9WeCanDraw13SceneDelegate")
